...
public class DocElementAdater extends RecyclerView.Adapter<DocElementAdater.ViewHolder> {
    ...
    public DocElementAdater(Context context) {
    ...
    @NonNull
    @Override
    public DocElementAdater.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
...
//            return new NormalViewholder(mHeaderView);
    ...
    @Override
    public void onBindViewHolder(@NonNull DocElementAdater.ViewHolder holder, int position) {
        if (getItemViewType(position) == TYPE_HEADER) {
            return;
        }
        DocAuditBean.ServerParamsBean.ReportListBean.WENJUANBean.WxysBean wxysBean = wxysBeans.get(position - 1);
